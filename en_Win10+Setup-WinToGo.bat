...
Function Copy_Progression ($Files,$Partition,$fs) {
    ...
    $ProgressLabel.Text = "File copying process starting..."
    ...
    ForEach ($File in $Files) {
        ...
        $OutputTextBox.AppendText("$index/$FilesCount - $(Split-Path $FileFullName -Leaf) copying...`r`n")
...
Function Start_Process {
    ...
    $result = [System.Windows.Forms.MessageBox]::Show(
        "USB device will be converted to MBR scheme, repartitioned and reformatted.`n`nAll current partitions and data on the USB device will be deleted.`n`nAre you sure you want to continue?",
        "WARNING",
    ...
    $OutputTextBox.Clear()
    $OutputTextBox.AppendText("Process starting...`r`n")
    $OutputTextBox.ScrollToCaret()
    ...
    try {
        ...
        if($Global:dvd){
            ...
            If($Global:ISO = (Get-DiskImage $Global:ImagePath|Get-Volume).DriveLetter){
                ...
                If(!($Global:ISO = (Mount-DiskImage $Global:ImagePath|Get-Volume).DriveLetter)){
                    Show_Error "Cannot mount ISO file"
                    return
                }
            }
        ...
        $OutputTextBox.AppendText("Preparation completed.`r`n")
        $OutputTextBox.ScrollToCaret()
        $Form.Refresh()
        ...
        Catch{
            Show_Error "Cannot create FAT32 partition"
            return
        }
        ...
        If($Global:SetUp){
            ...
            If ($FilesSize -gt $PartitionSize){
                Show_Error "FAT32 partition too small ($($PartitionSize.ToString("F2")) GB available, $($FilesSize.ToString("F2")) GB required)"
                return
            }
        ...
        $OutputTextBox.AppendText("Creating NTFS installation partition...`r`n")
        $OutputTextBox.ScrollToCaret()
        $Form.Refresh()
        ...
        Catch{
            Show_Error "Cannot create NTFS partition"
            return
        }
        ...
        If($Global:SetUp){
            ...
            If($FilesSize -gt $PartitionSize){
                Show_Error "NTFS partition too small ($($PartitionSize.ToString("F2")) GB available, $($FilesSize.ToString("F2")) GB required)"
                return
            }
        ...
        # File copying or image deployment
        If($Global:SetUp){
            ...
            $OutputTextBox.AppendText("Reading Windows To Go version information...`r`n")
            $OutputTextBox.ScrollToCaret()
            $Form.Refresh()
            ...
            # Check install.wim file existence
            ...
            try {
                ...
                if ($WindowsImages.Count -gt 0) {
                    ...
                    $OutputTextBox.AppendText("Select one of the listed Windows editions and click the 'Select' button.`r`n")
                    $OutputTextBox.ScrollToCaret()
                    return
                } else {
                    Show_Error "No Windows image found in selected ISO file"
                    return
                }
            } catch {
        ...
        # Unmount ISO
        If($Global:DVD){
            $OutputTextBox.AppendText("Unmounting mounted ISO image...`r`n")
            $OutputTextBox.ScrollToCaret()
            $Form.Refresh()
        ...
        Write_Additional_Files $Global:usbntfs
        
        # Completed
        $MainProgressBar.Value = 100
        $ProgressLabel.Text = "All operations completed successfully!"
        $OutputTextBox.AppendText("`r`n=== OPERATIONS COMPLETED ===`r`n")
        $OutputTextBox.AppendText("Disk created successfully!`r`n")
        $OutputTextBox.AppendText("You can safely remove the USB drive.`r`n")
        $OutputTextBox.ScrollToCaret()
...
Function Apply_WTG_Image {
    ...
    $MainProgressBar.Visible = $True
    $ProgressLabel.Visible = $True
    $ProgressLabel.Text = "Applying Windows To Go image. The process may take a long time, please wait..."
    ...
    try {
        ...
        If($job.State -ne "Completed"){
            ...
            Show_Error "Error applying image: $jobError"
            return
        }
        
        Remove-Job -Job $job -Force
        $OutputTextBox.AppendText("Windows To Go image applied successfully.`r`n")
        $OutputTextBox.ScrollToCaret()
        $Form.Refresh()
        ...
        Show_Error "Error applying Windows To Go image: $($_.Exception.Message)"
    }
}
...
Function Write_Additional_Files($usbntfs) {
...
"@ -replace '\s',''
    ...
    if ($hasInstallImage) {
        ...
        $OutputTextBox.AppendText("AutoUnattend.xml and auto.cmd files written.`r`n")
    }
    $OutputTextBox.ScrollToCaret()
}
...
$FileBrowser = New-Object System.Windows.Forms.OpenFileDialog -Property @{
    Title="Select ISO image or install.wim/esd in extracted source folder"
    Multiselect = $false
...
do {
    ...
    if ($FromDiskDrive.Count -eq 0) {
        $result = [System.Windows.Forms.MessageBox]::Show("No disk found.`n`nPlease insert or attach your disk first.", "Warning", [System.Windows.Forms.MessageBoxButtons]::RetryCancel, [System.Windows.Forms.MessageBoxIcon]::Warning)
...
$TabControl = New-Object System.Windows.Forms.TabControl -Property @{
    ...
    Size = New-Object System.Drawing.Size(460, 280)
}
...
$HowToText = New-Object System.Windows.Forms.RichTextBox -Property @{
    Location = New-Object System.Drawing.Point(10, 10)
    Size = New-Object System.Drawing.Size(420, 240)
    BackColor = "Gray"
    ForeColor = "White"
    ReadOnly = $True
    BorderStyle = "None"
...
2- Click Windows ISO button to select ISO file or install.wim/esd file in extracted folder. 
NOTE: .esd files cause errors in Windows To Go process. 

3- Select "Target USB Disk" from dropdown menu.		  

4- Select "Windows Setup Disk" or "Windows To Go" option.

5- Click "Create Disk" to create Windows Setup Disk or Windows To Go environment.																						   
"@
}
...
$OutputTextBox = New-Object System.Windows.Forms.TextBox -Property @{
    ...
    Size = New-Object System.Drawing.Size(460, 80)
    Multiline = $True
    ScrollBars = "Vertical"
    ReadOnly = $True
    BackColor = "Black"
...
$MainProgressBar = New-Object System.Windows.Forms.ProgressBar -Property @{
    Location = New-Object System.Drawing.Point(10, 390)
...
$ProgressLabel = New-Object System.Windows.Forms.Label -Property @{
    Location = New-Object System.Drawing.Point(10, 425)
...
$Windows = New-Object System.Windows.Forms.RadioButton -Property @{
    Location = New-Object System.Drawing.Point(30,125)
...
$Wintogo = New-Object System.Windows.Forms.RadioButton -Property @{
    Location = New-Object System.Drawing.Point(250,125)
    Text = "Windows To Go"
...
$WTGListBox = New-Object System.Windows.Forms.ListBox -Property @{
    ...
    Size = New-Object System.Drawing.Size(363, 100)
    Visible = $False
}
...
$OKButton = New-Object System.Windows.Forms.Button -Property @{
    Location = New-Object System.Drawing.Point(140, 210)
    Size = New-Object System.Drawing.Size(155, 26)
    Text = "Create Disk"
    Enabled = $False
}

$CancelButton = New-Object System.Windows.Forms.Button -Property @{
    Location = New-Object System.Drawing.Point(302, 210)
    Size = New-Object System.Drawing.Size(80, 25)
    Text = "Cancel"
}

$WTGSelectButton = New-Object System.Windows.Forms.Button -Property @{
    Location = New-Object System.Drawing.Point(385, 180)
    Size = New-Object System.Drawing.Size(60, 70)
    Text = "Select"
    Visible = $False
}
...
$CancelButton.Add_Click({
    if ($Global:ProcessRunning) {
        $result = [System.Windows.Forms.MessageBox]::Show("Are you sure you want to stop the process?", "Confirmation", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
        if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
            $Global:ProcessRunning = $False
            Enable_Controls
            $OutputTextBox.AppendText("Process stopped by user.`r`n")
            $OutputTextBox.ScrollToCaret()
        }
    } else {
        $Form.Close()
...
# Add controls
$MainTab.Controls.AddRange(@($Label1, $ISOFile, $TargetUSB, $WTGListBox, $SelectISOButton, $USBDiskList, $Wintogo, $Windows, $WTGSelectButton, $OKButton, $CancelButton))
$TabControl.TabPages.Add($MainTab)
$TabControl.TabPages.Add($HowToTab)
$Form.Controls.AddRange(@($TabControl, $OutputTextBox, $MainProgressBar, $ProgressLabel))

# Starting message
$OutputTextBox.AppendText("Ready. Select ISO file and click 'Create Disk' button.`r`n")
$OutputTextBox.ScrollToCaret()
